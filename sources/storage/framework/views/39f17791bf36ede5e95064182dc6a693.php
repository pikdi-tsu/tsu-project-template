    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form id="check_birthday" style="display:none;">
                ...
                <input value="<?php echo e($role); ?>" id="role" name="role" type="hidden">
            ...
            <form action="<?php echo e(route('NewPasswordAction')); ?>" method="POST" id="input_qa" style="display:none;">
                ...
                <div class="form-group mb-3">
                    <select name="q_1" class="form-control select2" required>
                        ...
                        <?php $__currentLoopData = $question_1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group mb-3">
                    <select name="q_2" class="form-control select2" style="width: 100%;" required>
                        ...
                        <?php $__currentLoopData = $question_2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    $('#check_birthday').submit(function(e){
        ...
        $.ajax({
            url: '<?php echo e(url('checkbirthday')); ?>',
            type: 'get',
...
<?php echo $__env->make('system::template/layout/masterlogin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\htdocs\tsu_siakad\sources\Modules\System\Providers/../Resources/views/login/newpassword.blade.php ENDPATH**/ ?>