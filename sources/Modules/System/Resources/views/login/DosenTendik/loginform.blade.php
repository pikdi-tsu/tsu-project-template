...
{{--            @if ($chance > 0)--}}
                ...
                <form id="form-login" method="POST" action="{{ route('login.action.dosen-tendik') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-envelope" style="user-select: none;"></span>
                            </div>
                        </div>
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a href="{{route('forgot_password.dosen_tendik')}}" class="btn btn-danger btn-block">Forgot
                                Password</a>
                        </div>
                        <!-- /.col -->
                        <div class="col-6">
